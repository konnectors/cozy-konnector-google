How to contribute to Cozy cozy-konnector-google-contacts?
====================================
...
- What is the version of the Cozy cozy-konnector-google-contacts?
...
```
$ git clone github.com/cozy/cozy-konnector-google-contacts.git
$ cd cozy-konnector-google-contacts
$ git remote add fork git://github.com/yourusername/cozy-konnector-google-contacts.git
```
...
Go to https://github.com/yourusername/cozy-konnector-google-contacts and select your branch. Click the 'Pull Request' button and fill out the form.
...
The Cozy cozy-konnector-google-contacts is translated on a platform called [Transifex][tx]. [This tutorial][tx-start] can help you to learn how to make your first steps here. If you have any question, don't hesitate to ask us!
...
[issues]: https://github.com/cozy/cozy-konnector-google-contacts/issues/new
...
[localization]: https://github.com/cozy/cozy-konnector-google-contacts/blob/master/README.md#localization
