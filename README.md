...
- [ ] use the Google people API
- [ ] get a Google OAuth2 token
- [ ] remove the Google OAuth2 form sight (and use cozy-collect instead)
- [ ] use cozy-collect to setup a Google OAuth2 token
- [ ] save Google contacts into Cozy
